                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        if ($row["TF_status"] == "Unpaid") {
                            echo '<a href="/Mini-Project-Web-Eng/Module4/trafficSummon.php?action=update&id=' . $row["TF_summonID"] . '"class="btn btn-update">Update</a>';
                            echo '<a href="/Mini-Project-Web-Eng/Module4/trafficSummon.php?action=cancel&id=' . $row["TF_summonID"] . '" class="btn btn-cancel">Cancel</a>';

                        } else {
                            echo '<a href="/Mini-Project-Web-Eng/Module4/trafficSummon.php?action=delete&id=' . $row["TF_summonID"] . '" class="btn btn-delete">Delete</a>';
                        }
                        echo '</td>';
                        echo "</tr>";
                    }
